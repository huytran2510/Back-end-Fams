...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		ApiInfo apiInfo = new ApiInfo("Tutorial REST API", "Project", "API Ver1.0", "Terms of service",
				new Contact("Tran Le Huy", "tranlehuy.com", "huy251003@gmail.com"), "License of API",
